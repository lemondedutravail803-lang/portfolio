...
const iaContent = {
    index: {
        ...
        sections: [
            ...
            { id: 'projets', name: 'Projets', text: "La section Projets présente tout ce qui a été fait pendant les sept semaines de formation Konexio. Huit projets sont réalisés : Jeu de Voiture créé avec Scratch, Site Portfolio en HTML et CSS, Figurine créée lors d'un atelier Cap Sciences, Montage Vidéo, OpenShot Vidéo, Formation Konexio de sept semaines, Jeu dans l'Espace en HTML, CSS et JavaScript, Google Docs et Google Sheets." },
