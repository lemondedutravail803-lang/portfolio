...
const iaContent = {
    index: {
        ...
        sections: [
            ...
            { id: 'projets', name: 'Projets', text: "La section Projets présente tous les projets réalisés pendant la formation Konexio. Huit projets sont présentés : Jeu de Voiture créé avec Scratch, Site Portfolio en HTML et CSS, Figurine créée lors d'un atelier Cap Sciences, Montage Vidéo, OpenShot Vidéo, Formation Konexio de sept semaines, Jeu dans l'Espace en HTML, CSS et JavaScript, Google Docs et Google Sheets." },
