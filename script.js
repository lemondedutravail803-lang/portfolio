...
// =========================================
// TRAÎNÉE DE SOURIS (CURSEUR WINDOWS GARDÉ)
// =========================================
...
let lastX = 0;
let lastY = 0;
const minDistance = 5; // Distance minimum entre chaque particule
...
document.addEventListener('mousemove', (e) => {
    ...
    // Créer une particule si la distance est suffisante
...
function createTrailParticle(x, y) {
    ...
    // Taille décroissante pour effet de perspective
